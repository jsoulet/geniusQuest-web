    ...
    resolve: [{
      ...
      resolveFn: () => {
        return challengeService
          .getAllChallenges()
          .then((challenges) => {
            return challenges.reduce((result, challenge) => challenge.hideAchievements ? result : _.concat(result, challenge.achievements.map((achievement) => _.assign({}, achievement, {title_en: challenge.title_en}))), [])
          })
